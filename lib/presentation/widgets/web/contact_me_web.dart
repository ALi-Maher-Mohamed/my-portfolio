  ...
  Widget _buildContactContent(
    ...
    return Row(
      ...
      children: [
        Expanded(
          flex: 1,
          child: _buildIntroSection(screenWidth, isLightMode),
        ),
        SizedBox(width: ResponsiveHelper.getAxisSpacing(screenWidth)),
        Expanded(
          flex: 1,
          child: _buildContactForm(isLightMode, screenWidth),
        ),
      ],
